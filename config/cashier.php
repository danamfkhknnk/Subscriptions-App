...
return [
    ...
    */
    ...
    'webhook' => [
        ...
        'events' => array_merge(WebhookCommand::DEFAULT_EVENTS, [
            // Trial lifecycle events the app also handles:
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This is the number of days a user can trial a subscription before
    | being charged. Set to null to disable trial period.
    |
    */
